...
import net.mcreator.ubran.procedures.FlamedropsProcedure;
import net.mcreator.ubran.procedures.FlameInWaterProcedure;
import net.mcreator.ubran.init.UbranModEntities;

import java.util.Set;

@Mod.EventBusSubscriber
public class FlameEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.AMBIENT).add(new MobSpawnSettings.SpawnerData(UbranModEntities.FLAME.get(), 20, 1, 4));
	}

	public FlameEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(UbranModEntities.FLAME.get(), world);
	}
	...
	public void baseTick() {
		super.baseTick();
		FlameInWaterProcedure.execute(this);
	}
