...
public class ScytheProcedurProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.getXRot() > 40 || entity.getXRot() < -40) {
			if ((world.getBlockState(new BlockPos(x + 1, y, z))).getMaterial() == net.minecraft.world.level.material.Material.LEAVES
			...
			if ((world.getBlockState(new BlockPos(x + 2, y, z))).getMaterial() == net.minecraft.world.level.material.Material.LEAVES
			...
			if ((world.getBlockState(new BlockPos(x + 1, y, z + 1))).getMaterial() == net.minecraft.world.level.material.Material.LEAVES
			...
			if ((world.getBlockState(new BlockPos(x + 2, y, z + 1))).getMaterial() == net.minecraft.world.level.material.Material.LEAVES
			...
			if ((world.getBlockState(new BlockPos(x + 1, y, z + 1))).getMaterial() == net.minecraft.world.level.material.Material.LEAVES
					&& !((world.getBlockState(new BlockPos(x + 2, y, z + 2))).getBlock() == Blocks.BEDROCK)) {
				{
			...
			if ((world.getBlockState(new BlockPos(x + 2, y, z - 2))).getMaterial() == net.minecraft.world.level.material.Material.LEAVES
					&& !((world.getBlockState(new BlockPos(x + 2, y, z - 2))).getBlock() == Blocks.BEDROCK)) {
				{
					BlockPos _pos = new BlockPos(x + 2, y, z - 2);
					Block.dropResources(world.getBlockState(_pos), world, new BlockPos(x, y, z), null);
			...
			if ((world.getBlockState(new BlockPos(x, y, z + 1))).getMaterial() == net.minecraft.world.level.material.Material.LEAVES
			...
			if ((world.getBlockState(new BlockPos(x, y, z + 2))).getMaterial() == net.minecraft.world.level.material.Material.LEAVES
			...
			if ((world.getBlockState(new BlockPos(x + 1, y + 1, z))).getMaterial() == net.minecraft.world.level.material.Material.LEAVES
			...
			if ((world.getBlockState(new BlockPos(x + 2, y + 1, z))).getMaterial() == net.minecraft.world.level.material.Material.LEAVES
					&& !((world.getBlockState(new BlockPos(x + 1, y + 1, z))).getBlock() == Blocks.BEDROCK)) {
				{
			...
			if ((world.getBlockState(new BlockPos(x, y + 1, z + 1))).getMaterial() == net.minecraft.world.level.material.Material.LEAVES
